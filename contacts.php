				...
				<div class="wrapper row">
					...
					<div class="wrap-col">
						...
						<div>
							...
							<div  class="wrapper" id ="rte1" style="display: none;">
							<span style="color: red;">Wrong!!..>>></span>
								<div style="color: red;"><strong>Empty Name!..Please enter your name..Thank you.</strong></div>
							</div>
							...
							<div  id ="rte2" class="wrapper" style="display: none;">
							<span style="color: red;">Wrong!!..>>></span>
								<div  style="color: red;"><strong>Empty City!..Please enter your city..Thank you.</strong></div>
							</div>
							...
							<div id ="rte3" class="wrapper" style="display: none;">
							<span style="color: red;">Wrong!!..>>></span>
								<div  style="color: red;"><strong>Empty E-mail!..Please enter your Email..Thank you.</strong></div>
							</div>
							
							<div id ="rte4" class="wrapper" style="display: none;">
							<span style="color: red;">Wrong!!..>>></span>
								<div  style="color: red;"><strong>Incorrect E-mail!..Please enter another Email..Thank you.</strong></div>
							</div>
							...
							<div id ="rte5" class="wrapper" style="display: none;">
							<span style="color: red;">Wrong!!..>>></span>
								<div  style="color: red;"><strong>Empty Message!..Please enter the message..Thank you.</strong></div>
							</div>
							
                            <div  class="wrapper">
							
								<input  type="button" class="button" style="color: white;height: 30px;width:100px; background-color: green;"  onclick="form_info()" value="Send" />
							
							</div>
							
                            <div id ="rte6" class="wrapper" style="display: none;">
								<div  style="color: red;"><strong>Page not found!</strong><br />Please try again later...Thank you.</div>
							</div>
							
							<div id ="rte7" class="wrapper" style="display: none;">
								<div  style="color: green;"><strong>Your Message has been send successfully.</strong><br />We will contact with you very soon...Thank you.</div>
							</div>
...
<script type="text/javascript"> 
    ...
    function form_info(){
     ...
     var info = { 'name':$('#name').val() , 'city':$('#city').val() , 'message':$('#message').val() , 'email':$('#email').val()}   
        
        
         $.get("savecontact.php",info, function(data){
        
           if ($.trim(data) == 'empty name') 	
           	{$('#rte1').css("display","block")
           	 $('#rte1').fadeOut(10000);}
           
           if ($.trim(data) == 'empty city') 	
           	{$('#rte2').css("display","block")
           	$('#rte2').fadeOut(10000);}
           	
           if ($.trim(data) == 'empty email')	
           	{$('#rte3').css("display","block")
           	$('#rte3').fadeOut(10000);}
           
           if ($.trim(data) == 'wrong_email')	
           	{$('#rte4').css("display","block")
           	$('#rte4').fadeOut(10000);}
           
           if ($.trim(data) == 'empty message')	
            {$('#rte5').css("display","block")
            $('#rte5').fadeOut(10000);}
            
           if(($.trim(data) == 'false') || (data == 'failur')) 
            {$('#rte6').css("display","block")
            $('#rte6').fadeOut(13000);} 
           
           if ($.trim(data) == 'true')
            {$('#rte7').css("display","block")
             $('#rte7').fadeOut(15000) 
             $('#name').val(''),$('#message').val(''),$('#email').val(''),$('#city').val(''); }
...
?>	
					...
					<div class="wrap-col">
						...
						<div id="address"><span>Country:<br>
								...
								<?= get_set('City') ?><br>
								<?= get_set('Phone') ?><br>
								<a class="link1" href=<?= get_set('Contacts_Email_link') ?>><?= limit_text(get_set('Contacts_Email_title'),3) ?></a></div>
						<h2 class="under"><?= limit_text(get_set('Contacts_Note_title'),3) ?></h2>
						<p><?= limit_text(get_set('Contacts_Note_content'),45) ?></p>
					</div>
					</section>
				</div>
