...
echo('<div class="row-fluid">
        ...
        <p>Yes Iam sure<a href="deletecontact.php?p='.$contact->contact_id.'& c=1">...Delete Message of '.$contact->name.' </a></p>
        <p>----------------------</p>
        <li> OR </li>
        <p>----------------------</p>
        <p><i class="icon-twitter"></i></p>
        <p>No..Back to<a href="contacts.php"> Contacts page</a></p>
      </div>
      </div>');
...
$result = prog_contacts_delete($_id);
if($result)
...
{   prog_db_close();
	echo('<div class="row-fluid">
	    <div class="http-error">
        <h1>Success!</h1>
        <p class="info">Message has been deleted...Thank you.</p>
        <p><i class="icon-twitter"></i></p>
        <p><a href="contacts.php">Back to Contacts page</a></p>
    </div>
    </div>');
