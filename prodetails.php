...
?>					
				<div class="wrapper row">
					<section class="col-3-8">
						<div class="wrap-col">
							<h2 class="under"><?php echo $p->prod_name;?></h2>
							<div class="wrapper">
								<figure class="left marg_right1" style="width: 940px;height: 430px;"><img src="admin/images/<?php echo $p->image;?>" alt="" style="width: 940px;height: 423px;"></figure>
								<p class="pad_bot1"><strong><?php echo $p->content;?></strong></p>
							</div>
						</div>
					</section>
