...
?>					
				...
				<div class="wrapper row">
					<center><section class="col-3-8">
						<div class="wrap-col">
							<h2 class="under">Testimonial</h2>
							<div class="wrapper">
								<li><p class="color1"><strong><?php echo $t->desc;?></strong></p></li>
								<li><p class="pad_bot1"><?php echo $t->content;?></p></li><br>
								<p class="pad_bot1"><i><strong>Name : </strong><?php echo $t->name;?></i></p>
							    <p class="pad_bot1"><i><strong>Job : </strong><?php echo $t->job;?></i></p>
							</div>
						</div>
					</section></center>
